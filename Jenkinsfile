    ...
    stage('Docker-Push-Multi') {
      ...
      steps {
        withCredentials([
          ...
          sh "docker tag ${IMAGE}:arm32v7-${META_TAG} ${IMAGE}:arm32v7-bionic"
          ...
          sh "docker push ${IMAGE}:arm32v7-bionic"
          sh "docker push ${IMAGE}:arm64v8-bionic"
          sh "docker manifest push --purge ${IMAGE}:bionic || :"
          sh "docker manifest create ${IMAGE}:bionic ${IMAGE}:amd64-bionic ${IMAGE}:arm32v7-bionic ${IMAGE}:arm64v8-bionic"
          sh "docker manifest annotate ${IMAGE}:bionic ${IMAGE}:arm32v7-bionic --os linux --arch arm"
